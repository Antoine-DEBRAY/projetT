...
// Code is generated on: 20/03/2023 08:54:05
//
...
namespace BddpersonnelContext
{
    ...
    public partial class BddpersonnelDataContext : Devart.Data.Linq.DataContext
    {
        ...
        {
            System.Configuration.ConnectionStringSettings connectionStringSettings = new System.Configuration.ConnectionStringSettings(); //System.Configuration.ConfigurationManager.ConnectionStrings[connectionStringName];
           // if (connectionStringSettings == null)
               // System.Configuration.ConnectionStringSettings connectionStringSettings = new System.Configuration.ConnectionStringSettings();
                connectionStringSettings.ConnectionString = @"User Id=userBDDR;Password=Password1234@il;Host=172.16.32.235;Port=3306;Database=bddpersonnels;Persist Security Info=True";
...
namespace BddpersonnelContext
{
    ...
    public partial class Fonction : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public static int ComparerLabelFonctions(Fonction fonction1, Fonction fonction2)
        {
            return fonction1.Intitule.CompareTo(fonction2.Intitule);
        }
    ...
    public partial class Service : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<Personnel> _Personnels;
        public static int ComparerLabelServices(Service service1, Service service2)
        {
            return service1.Intitule.CompareTo(service2.Intitule);
        }
